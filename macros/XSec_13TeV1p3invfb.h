...
std::map<std::string, float> GetLumis() {
    ...
    values["ZH_HToBB_ZToNuNu_M125_13TeV_amcatnloFXFX_madspin_pythia8"                ] = lumi *         0.0 / 1.16478525000000000e+06;
    values["WH_HToBB_WToLNu_M125_13TeV_amcatnloFXFX_madspin_pythia8"                 ] = lumi *         0.0 / 1.12889112500000000e+06;
    values["ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8"                                ] = lumi *         0.0 / 1.86044725000000000e+06;
